...
export default function RandomQuizError({ reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex flex-col items-center gap-4 py-20 text-center">
      ...
      <div className="flex gap-3">
        ...
        {levelId && (
          <Link href={`/dashboard/quizzes/${levelId}`} className="rounded-md border px-4 py-2 text-sm hover:bg-muted">
            Testlere dön
          </Link>
        )}
      </div>
